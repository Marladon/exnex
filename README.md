...
* Сообщения отображаются как "аноним" при работе в нескольких вкладках браузера.
* Дополнительно (рекомендуется):
    + Добавить синхронизацию между вкладками через событие storage
    + Или использовать функцию-геттер вместо глобальной переменной